...
const App: React.FC = () => {
    ...
    }, [audioStreaming, mediaConfig.microphoneId, mediaConfig.cameraId, mediaConfig.screenAudio, screenSharing, videoStreaming, toggleAudio, toggleVideo, toggleScreen, config]);
