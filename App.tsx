...
const App: React.FC = () => {
    ...
    }, [audioStreaming, videoStreaming, screenSharing, mediaConfig.microphoneId, mediaConfig.cameraId, mediaConfig.screenAudio, toggleAudio, toggleVideo, toggleScreen, config]);
