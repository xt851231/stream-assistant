            ...
            >
                <form onSubmit={handleSubmit} className="flex gap-2 items-center h-10 w-full">
                    <input
                        ...
                        className="flex-1 min-w-0 bg-[#0a0f16] border border-gray-600 text-white rounded px-3 text-[11px] focus:outline-none focus:border-[#ffd700] placeholder-gray-600 font-ark transition-colors h-full"
