                    ...
                    {field.type === 'select' ? (
                        ...
                        <div className="flex items-center justify-between bg-[#162032] p-2 rounded border border-gray-700">
                            ...
                            <button
                                ...
                                className={`w-8 h-4 rounded-full relative transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-[#ffd700] focus-visible:ring-offset-[#162032] ${config[settingId as keyof AppConfig] ? 'bg-green-500' : 'bg-gray-600'}`}
                            >
                        ...
                        <section className="space-y-3">
                            ...
                            <div className="flex items-center justify-between bg-[#162032] p-2 rounded border border-gray-700">
                                ...
                                <button
                                    ...
                                    className={`w-8 h-4 rounded-full relative transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-[#ffd700] focus-visible:ring-offset-[#162032] ${themeConfig?.userAssets?.startScreenAudio ? 'bg-green-500' : 'bg-gray-600'}`}
                                >
