                ...
                <div key={settingId} className="space-y-1">
                    ...
                    {field.type === 'select' ? (
                        ...
                        <div className="flex items-center justify-between bg-[#162032] p-2 rounded border border-gray-700">
                            <span id={`label-${settingId}`} className="text-xs text-gray-300">{t(`systemConfig.fields.${settingId}`, field.label)}</span>
                            <button
                                role="switch"
                ...
                {activeTab === 'appearance' && (
                    <div className="space-y-6">
                        ...
                        <section className="space-y-3">
                            ...
                            <div className="flex items-center justify-between bg-[#162032] p-2 rounded border border-gray-700">
                                <span id="label-enable-audio" className="text-xs text-gray-300">{t('appearance.enableAudio', 'Enable Audio (Video Only)')}</span>
                                <button
                                    role="switch"
