                    ...
                    {field.type === 'select' ? (
                        ...
                        <div className="flex items-center justify-between bg-[#162032] p-2 rounded border border-gray-700">
                            ...
                            <button
                                ...
                                className={`w-8 h-4 rounded-full relative transition-colors focus-visible:ring-2 focus-visible:ring-[#ffd700] focus:outline-none ${config[settingId as keyof AppConfig] ? 'bg-green-500' : 'bg-gray-600'}`}
                            >
                        ...
                        <section className="space-y-3">
                            ...
                            <div className="flex items-center justify-between bg-[#162032] p-2 rounded border border-gray-700">
                                ...
                                <button
                                    ...
                                    className={`w-8 h-4 rounded-full relative transition-colors focus-visible:ring-2 focus-visible:ring-[#ffd700] focus:outline-none ${themeConfig?.userAssets?.startScreenAudio ? 'bg-green-500' : 'bg-gray-600'}`}
                                >
