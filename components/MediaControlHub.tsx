            ...
            >
                ...
                <div className="flex items-center justify-between bg-[#111827] p-2 rounded border border-gray-700">
                    <div className="flex items-center gap-2 text-xs text-gray-300">
                        ...
                        <span id="label-screenAudio">{t('mediaControl.screenAudio', 'Share System Audio')}</span>
                    </div>
                    <button
                        type="button"
                        role="switch"
                        aria-checked={Boolean(config.screenAudio)}
                        aria-labelledby="label-screenAudio"
                        onClick={() => handleChange('screenAudio', !config.screenAudio)}
                        className={`w-8 h-4 rounded-full relative transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 focus-visible:ring-offset-[#111827] ${config.screenAudio ? 'bg-green-500' : 'bg-gray-600'}`}
                    >
