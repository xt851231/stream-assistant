            ...
            >
                ...
                <div className="flex items-center justify-between bg-[#111827] p-2 rounded border border-gray-700">
                    <div className="flex items-center gap-2 text-xs text-gray-300">
                        ...
                        <span id="label-share-system-audio">{t('mediaControl.screenAudio', 'Share System Audio')}</span>
                    </div>
                    <button
                        role="switch"
                        aria-checked={!!config.screenAudio}
                        aria-labelledby="label-share-system-audio"
                        onClick={() => handleChange('screenAudio', !config.screenAudio)}
                        className={`w-8 h-4 rounded-full relative transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ffd700] focus-visible:ring-offset-1 focus-visible:ring-offset-[#111827] ${config.screenAudio ? 'bg-green-500' : 'bg-gray-600'}`}
                    >
