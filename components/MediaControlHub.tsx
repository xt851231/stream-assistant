            ...
            >
                ...
                <div className="flex items-center justify-between bg-[#111827] p-2 rounded border border-gray-700">
                    ...
                    <button
                        ...
                        className={`w-8 h-4 rounded-full relative transition-colors focus-visible:ring-2 focus-visible:ring-blue-400 focus:outline-none ${config.screenAudio ? 'bg-green-500' : 'bg-gray-600'}`}
                    >
