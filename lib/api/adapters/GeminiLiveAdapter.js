    ...
    handleIncomingMessage(message) {
        ...
        if (serverContent) {
            ...
            if (serverContent.inputTranscription) {
                console.log('📝 Input transcription (serverContent) received');
                this.emit('content', {
            ...
            if (serverContent.outputTranscription) {
                console.log('📝 Output transcription (serverContent) received');
                this.emit('content', {
        ...
        if (message.inputTranscription && !serverContent?.inputTranscription) {
            console.log('📝 Input transcription (top-level) received');
            this.emit('content', {
                type: 'input_transcription',
        ...
        if (message.outputTranscription && !serverContent?.outputTranscription) {
            console.log('📝 Output transcription (top-level) received');
            this.emit('content', {
                type: 'output_transcription',
