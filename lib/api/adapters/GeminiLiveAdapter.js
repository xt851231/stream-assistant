    ...
    handleIncomingMessage(message) {
        ...
        if (serverContent) {
            ...
            if (serverContent.inputTranscription) {
                console.log('📝 Input transcription received (serverContent)');
                this.emit('content', {
            ...
            if (serverContent.outputTranscription) {
                console.log('📝 Output transcription received (serverContent)');
                this.emit('content', {
        ...
        if (message.inputTranscription && !serverContent?.inputTranscription) {
            console.log('📝 Input transcription received (top-level)');
            this.emit('content', {
                type: 'input_transcription',
        ...
        if (message.outputTranscription && !serverContent?.outputTranscription) {
            console.log('📝 Output transcription received (top-level)');
            this.emit('content', {
                type: 'output_transcription',
