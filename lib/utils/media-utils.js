 ...
 */
import { arrayBufferToBase64, base64ToArrayBuffer } from './base64-utils.js';
...
export class AudioPlayer {
  ...
  async play(base64Audio) {
    ...
    try {
      ...
      // Convert base64 to Float32Array using optimized utility
      const buffer = base64ToArrayBuffer(base64Audio);
      const inputArray = new Int16Array(buffer);
      ...
      for (let i = 0; i < len; i++) {
        float32Data[i] = inputArray[i] * factor;
      }
